...
const UI: Record<Locale, UiDictionary> = {
  en: {
    ...
    dynamic: {
      ...
      toastSample: "built-in plan selected",
    ...
    copy: {
      ...
      "#step-one-title": "Choose or upload a floor plan",
      ".upload-empty strong": "Drop a plan, or click to browse",
      ".upload-empty small": "PNG / JPG / WEBP / SVG · 10 MB max",
      ".sample-picker legend": "Or start with a 50 m² plan variant",
      ".sample-plan-card[data-sample-plan='end-entry'] strong": "End entry",
      ".sample-plan-card[data-sample-plan='end-entry'] small": "Short-side entry",
      ".sample-plan-card[data-sample-plan='central-entry'] strong": "Central entry",
      ".sample-plan-card[data-sample-plan='central-entry'] small": "Split service + WC",
      ".sample-plan-card[data-sample-plan='fixed-core'] strong": "Fixed core",
      ".sample-plan-card[data-sample-plan='fixed-core'] small": "Core + column",
      ...
      ".prompt-tip":
        "<span>TIP</span> Built-in plans are public and fetchable. Uploads exist only in this browser, so send an uploaded source image with the prompt.",
  ...
  zh: {
    ...
    copy: {
      ...
      "#step-one-title": "选择或上传平面图",
      ".upload-empty strong": "拖放图纸，或点击选择",
      ".upload-empty small": "PNG / JPG / WEBP / SVG · 最大 10MB",
      ".sample-picker legend": "或选择一个 50㎡ 平面图变体",
      ".sample-plan-card[data-sample-plan='end-entry'] strong": "端部入口",
      ".sample-plan-card[data-sample-plan='end-entry'] small": "短边入口",
      ".sample-plan-card[data-sample-plan='central-entry'] strong": "中央入口",
      ".sample-plan-card[data-sample-plan='central-entry'] small": "服务区与 WC 分置",
      ".sample-plan-card[data-sample-plan='fixed-core'] strong": "固定核心",
      ".sample-plan-card[data-sample-plan='fixed-core'] small": "核心区与结构柱",
      ...
      ".prompt-tip":
        "<span>提示</span> 内置平面图可公开读取；上传图只存在于当前浏览器，请把上传的原图与 Prompt 一起交给 Agent。",
